...
Given /^an initial business$/ do
  ...
  @hersh = Factory.create(:employee, :first_name => "Jon", :last_name => "Hersh", :ssn => "234567890", :phone => "4122683259", :role => "manager", :date_of_birth => 27.years.ago.to_date)
  @rubinstein = Factory.create(:employee, :first_name => "Ari", :last_name => "Rubinstein", :ssn => "234567891", :phone => "4122683258", :role => "manager", :date_of_birth => 25.years.ago.to_date)
  ...
  @schell = Factory.create(:employee, :first_name => "Evan", :last_name => "Schell", :ssn => "567890123", :phone => "4122684209", :date_of_birth => "1992-03-15")
  ...
  @daigle_assign = Factory.create(:assignment, :employee => @daigle, :store => @acac, :start_date => "2011-11-22", :end_date => nil, :pay_level => 3)
  ...
  @schell_assign = Factory.create(:assignment, :employee => @schell, :store => @acac, :start_date => 4.years.ago.to_date, :end_date => 2.years.ago.to_date, :pay_level => 2)
  @promote_schell = Factory.create(:assignment, :employee => @schell, :store => @convention, :start_date => 2.years.ago.to_date, :end_date => nil, :pay_level => 3)
